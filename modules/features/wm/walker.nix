      ...
      themes = {
        "catppuccin" = {
          style = ''
            ...
            @define-color accent_bg_color ${palette.teal.hex};
            @define-color theme_fg_color ${palette.text.hex};
            @define-color error_bg_color ${palette.maroon.hex};
            @define-color error_fg_color ${palette.subtext0.hex};
            ...
            * {
            ...
            .box-wrapper {
              ...
              padding: 20px;
              border-radius: 20px;
              border: 0px solid darker(@accent_bg_color);
            }
